...
class _PassDetailScreenState extends State<PassDetailScreen> {
  ...
  void _showPastTimeMessage() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Past time is not allowed for today.')),
    );
  }
            ...
            Container(
              ...
              child: PrimaryButton(
                ...
                callback: () async {
                  ...
                  final PurchaseResult result = await context
                      .read<PassViewModel>()
                      .purchase(widget.plan, startDate: _selectedStartDateTime);
                  ...
                  if (result == PurchaseResult.failed) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'Failed to purchase pass. Please try again.',
                        ),
                      ),
                    );
                    return;
